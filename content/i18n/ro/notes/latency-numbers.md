---
date: 2026-01-07
title: Numere de latență pe care fiecare programator ar trebui să le cunoască
tags:
    - performance
    - systems
    - engineering
...
Numere pe care le țin la îndemână pentru verificări rapide de performanță.

Unități:
- 1 ns = $10^{-9}$ secunde
- 1 us = $10^{-6}$ secunde = 1,000 ns
- 1 ms = $10^{-3}$ secunde = 1,000 us = 1,000,000 ns
...
Sursă: https://github.com/sirupsen/napkin-math
...
Extra
------
- Comparație umanizată: https://gist.github.com/hellerbarde/2843375
- Diagramă de comparație vizuală: http://i.imgur.com/k0t1e.png
- Prezi interactiv: https://prezi.com/pdkvgys-r0y6/latency-numbers-for-programmers-web-development/latency.txt (original: https://gist.github.com/jboner/2841832)
