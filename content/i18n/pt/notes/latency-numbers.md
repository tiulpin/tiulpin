---
date: 2026-01-07
title: Números de Latência que Todo Programador Deveria Conhecer
tags:
    - performance
    - systems
    - engineering
...
Números que mantenho à mão para verificações rápidas de desempenho.
...
Fonte: https://github.com/sirupsen/napkin-math
...
Extras
------
- Comparação humanizada: https://gist.github.com/hellerbarde/2843375
- Gráfico de comparação visual: http://i.imgur.com/k0t1e.png
- Prezi interativo: https://prezi.com/pdkvgys-r0y6/latency-numbers-for-programmers-web-development/latency.txt (original: https://gist.github.com/jboner/2841832)
