---
date: 2026-01-07
title: Nombres de latence que tout programmeur devrait connaître
tags:
    - performance
    - systems
    - engineering
...
Nombres que je garde à portée de main pour des vérifications de performance approximatives.

Unités :
- 1 ns = $10^{-9}$ secondes
- 1 us = $10^{-6}$ secondes = 1 000 ns
- 1 ms = $10^{-3}$ secondes = 1 000 us = 1 000 000 ns
...
Extras
------
- Comparaison humanisée : https://gist.github.com/hellerbarde/2843375
- Graphique de comparaison visuelle : http://i.imgur.com/k0t1e.png
- Prezi interactif : https://prezi.com/pdkvgys-r0y6/latency-numbers-for-programmers-web-development/latency.txt (original : https://gist.github.com/jboner/2841832)
